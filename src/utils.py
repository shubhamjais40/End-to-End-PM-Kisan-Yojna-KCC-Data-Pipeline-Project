...
def calenderGenerater(start:str,end:str,freq:str):
    ...
    calender = pd.DataFrame(data={'date':dummy,'day':dummy.dt.day,'weekday':dummy.dt.dayofweek,'month':dummy.dt.month,'quarter':dummy.dt.quarter,'year':dummy.dt.year},index=None)
